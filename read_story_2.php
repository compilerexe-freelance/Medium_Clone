                ...
                <div class="col-xs-12 col-sm-12 col-md-10 col-md-offset-1">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12" style="padding-left: 0px !important; padding-right: 0px !important;">
                        <div class="col-xs-7 col-sm-12 col-md-4">
                            <div class="form-group" style="margin-top: 20px;">
                                ...
                                <span for="" style="margin-left: 10px;" class="font-color-green">Compiler Exe</span>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <img src="assets/images/article_2.jpg" alt="" style="width: 100%">
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <span style="font-size: 30px;"><b>3 Tips you need to know before travel!</b></span>
                        </div>
                        <div class="form-group" style="margin-bottom: 30px;">
                            <span style="font-size: 20px;" class="font-color-gray">
                                If this is the first trip to travelling I think this is the tips you should do or maybe bring it before your trip<br><br>
                                <ol>
                                    <li>Get guidebooks - guidebooks usually include the map of this city</li>
                                    <li>Make sure you money enough and your credit card will work</li>
                                    <li>Bring the charger adapter - as you know some countries have the different size of plug and voltage</li>
                                </ol>
                            </span>
                        </div>
                        <div class="form-group">
                            <i class="fa fa-tags"></i> Life, Travel
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-group" style="margin-top: 20px; padding-bottom: 50px;">
                        ...
                        <div class="form-inline">
                            <div class="form-group pull-left">
                                ...
                                <span for="" style="margin-left: 10px;" class="font-color-green">Peter</span>
                            </div>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="col-md-6 col-md-offset-3">
                        ...
                        <div class="form-group" style="margin-top: 20px;">
                            <img src="assets/images/icons/user.png" style="width: 50px; heigth: 50px;" class="img-circle" alt="">
                            <span for="" style="margin-left: 10px;" class="font-color-green">Tester 3</span>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-6 col-md-offset-3">
                        ...
                        <div class="form-group" style="margin-top: 20px;">
                            <img src="assets/images/icons/user.png" style="width: 50px; heigth: 50px;" class="img-circle" alt="">
                            <span for="" style="margin-left: 10px;" class="font-color-green">Tester 1 <span class="font-color-gray pull-right">7 days ago</span></span>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-6 col-md-offset-3">
                        ...
                        <div class="form-group" style="margin-top: 20px;">
                            <img src="assets/images/icons/user.png" style="width: 50px; heigth: 50px;" class="img-circle" alt="">
                            <span for="" style="margin-left: 10px;" class="font-color-green">Tester 2 <span class="font-color-gray pull-right">10 days ago</span></span>
                        </div>
                        <div class="form-group">
